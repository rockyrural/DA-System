...
Public Class SendAckToSubmissionEmail
    ...
    Private Sub btnSend_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSend.Click
        ...
        sEmailMsg.Append("<P><FONT FACE='Calibri'>Please find attached acknowledgement letter in response to your Submission to Development Application " & _DaNo & ".</FONT></P>")
        sEmailMsg.Append("<P><FONT FACE='Calibri'> Thank you.</FONT></P>")
        sEmailMsg.Append("</BODY></HTML>")
        sEmailMsg.Append("")


        Dim SubjectText As String = "Acknowledgement letter in response to submission to DA " & _DaNo & " - " & _developmentAddress
