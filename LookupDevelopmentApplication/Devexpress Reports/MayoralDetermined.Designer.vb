...
Partial Public Class MayoralDetermined
    ...
    Private Sub InitializeComponent()
        ...
        Me.XrPageInfoPages.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
        ...
        'XrLabel3
        '
        Me.XrLabel3.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "usp_rpt_DADetermSummary(@STARTDATE, @ENDDATE).DADetermDt", "{0:dd/MM/yyyy}")})
