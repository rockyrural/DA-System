...
Public Class DCPCheckList6
    ...
    Private Sub DCPCheckList6_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub DCPCheckList6_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub SetUpDCPCheck1ComboBoxs()
        ...
        Dim DWCompSent As New ArrayList
        ...
        With Me.cboDWCoombSent
            .DataSource = DWCompSent
            .DisplayMember = "Name"
            .ValueMember = "Key"
            .SelectedIndex = -1
        End With

        Dim DWCompSExt As New ArrayList
        ...
        With Me.cboDWCoombSext
            .DataSource = DWCompSExt
            .DisplayMember = "Name"
            .ValueMember = "Key"
            .SelectedIndex = -1
        End With

        Dim DWSpace As New ArrayList
        ...
        Dim OSVisitorPark As New ArrayList
        ...
        With Me.cboOSvisitorParking
            .DataSource = OSVisitorPark
            .DisplayMember = "Name"
            .ValueMember = "Key"
            .SelectedIndex = -1
        End With
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    With cmd
                        ...
                        .Parameters.Add("@FORM", SqlDbType.Int).Value = 6
                        ...
                        .Parameters.Add("@COMBEE", SqlDbType.NVarChar).Value = Me.DWCombEETextBox.Text
                        .Parameters.Add("@COMBEECMP", SqlDbType.NVarChar).Value = Me.cboDWCombEE.SelectedValue.ToString
                        ...
                        .Parameters.Add("@COMPSENT", SqlDbType.NVarChar).Value = Me.DWCombSEntTextBox.Text
                        .Parameters.Add("@COMPSENTCMP", SqlDbType.NVarChar).Value = Me.cboDWCoombSent.SelectedValue.ToString
                        .Parameters.Add("@COMPSEXT", SqlDbType.NVarChar).Value = Me.DWCombSExtTextBox.Text
                        .Parameters.Add("@COMPSEXTCMP", SqlDbType.NVarChar).Value = Me.cboDWCoombSext.SelectedValue.ToString
                        .Parameters.Add("@DWSPACE", SqlDbType.NVarChar).Value = Me.DWSpaceTextBox.Text
                        .Parameters.Add("@DWSPACECMP", SqlDbType.NVarChar).Value = Me.cboDWSpace.SelectedValue.ToString
                        .Parameters.Add("@EPS", SqlDbType.NVarChar).Value = Me.EPSValueTextBox.Text
                        .Parameters.Add("@EPSCMP", SqlDbType.NVarChar).Value = Me.cboEPS.SelectedValue.ToString
                        .Parameters.Add("@VISITOR", SqlDbType.NVarChar).Value = Me.OSVisitorValueTextBox.Text
                        .Parameters.Add("@VISITORCMP", SqlDbType.NVarChar).Value = Me.cboOSvisitorParking.SelectedValue.ToString
    ...
    Private Function CheckDataEntry() As Boolean
        ...
        If Me.cboEPS.Text = String.Empty Then
            With ErrorProvider
                .SetIconAlignment(Me.cboEPS, ErrorIconAlignment.MiddleRight)
                .SetError(Me.cboEPS, "Answer is required")
            End With
            result = False
        Else
            ErrorProvider.SetError(Me.cboEPS, "")

            If cboEPS.SelectedValue.ToString <> "O" Then
                If Me.EPSValueTextBox.Text = String.Empty Then
                    With ErrorProvider
                        .SetIconAlignment(Me.EPSValueTextBox, ErrorIconAlignment.MiddleRight)
                        .SetError(Me.EPSValueTextBox, "Answer is required")
                    End With
                    result = False
                Else
                    ErrorProvider.SetError(Me.EPSValueTextBox, "")
        ...
        If Me.cboDWCombEE.Text = String.Empty Then
            With ErrorProvider
                .SetIconAlignment(Me.cboDWCombEE, ErrorIconAlignment.MiddleRight)
                .SetError(Me.cboDWCombEE, "Answer is required")
            End With
            result = False
        Else
            ErrorProvider.SetError(Me.cboDWCombEE, "")

            If cboDWCombEE.SelectedValue.ToString <> "O" Then
                If Me.DWCombEETextBox.Text = String.Empty Then
                    With ErrorProvider
                        .SetIconAlignment(Me.DWCombEETextBox, ErrorIconAlignment.MiddleRight)
                        .SetError(Me.DWCombEETextBox, "Answer is required")
                    End With
                    result = False
                Else
                    ErrorProvider.SetError(Me.DWCombEETextBox, "")
        ...
        If Me.cboDWCoombSent.Text = String.Empty Then
            With ErrorProvider
                .SetIconAlignment(Me.cboDWCoombSent, ErrorIconAlignment.MiddleRight)
                .SetError(Me.cboDWCoombSent, "Answer is required")
            End With
            result = False
        Else
            ErrorProvider.SetError(Me.cboDWCoombSent, "")

            If cboDWCoombSent.SelectedValue.ToString <> "O" Then
                If Me.DWCombSEntTextBox.Text = String.Empty Then
                    With ErrorProvider
                        .SetIconAlignment(Me.DWCombSEntTextBox, ErrorIconAlignment.MiddleRight)
                        .SetError(Me.DWCombSEntTextBox, "Answer is required")
                    End With
                    result = False
                Else
                    ErrorProvider.SetError(Me.DWCombSEntTextBox, "")
        ...
        End If
        If Me.cboDWCoombSext.Text = String.Empty Then
            With ErrorProvider
                .SetIconAlignment(Me.cboDWCoombSext, ErrorIconAlignment.MiddleRight)
                .SetError(Me.cboDWCoombSext, "Answer is required")
            End With
            result = False
        Else
            ErrorProvider.SetError(Me.cboDWCoombSext, "")

            If cboDWCoombSext.SelectedValue.ToString <> "O" Then
                If Me.cboDWCoombSext.Text = String.Empty Then
                    With ErrorProvider
                        .SetIconAlignment(Me.cboDWCoombSext, ErrorIconAlignment.MiddleRight)
                        .SetError(Me.cboDWCoombSext, "Answer is required")
        ...
        End If
        If Me.cboDWSpace.Text = String.Empty Then
            With ErrorProvider
                .SetIconAlignment(Me.cboDWSpace, ErrorIconAlignment.MiddleRight)
                .SetError(Me.cboDWSpace, "Answer is required")
            End With
            result = False
        Else
            ErrorProvider.SetError(Me.cboDWSpace, "")

            If cboDWSpace.SelectedValue.ToString <> "O" Then
                If Me.cboDWSpace.Text = String.Empty Then
                    With ErrorProvider
                        .SetIconAlignment(Me.cboDWSpace, ErrorIconAlignment.MiddleRight)
                        .SetError(Me.cboDWSpace, "Answer is required")
        ...
        If Me.cboOSvisitorParking.Text = String.Empty Then
            With ErrorProvider
                .SetIconAlignment(Me.cboOSvisitorParking, ErrorIconAlignment.MiddleRight)
                .SetError(Me.cboOSvisitorParking, "Answer is required")
            End With
            result = False
        Else
            ErrorProvider.SetError(Me.cboOSvisitorParking, "")

            If cboOSvisitorParking.SelectedValue.ToString <> "O" Then
                If Me.OSVisitorValueTextBox.Text = String.Empty Then
                    With ErrorProvider
                        .SetIconAlignment(Me.OSVisitorValueTextBox, ErrorIconAlignment.MiddleRight)
                        .SetError(Me.OSVisitorValueTextBox, "Answer is required")
                    End With
                    result = False
                Else
                    ErrorProvider.SetError(Me.OSVisitorValueTextBox, "")
