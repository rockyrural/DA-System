...
Public Class DCPCheckList1
    ...
    Private Sub DCPCheckList1_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub DCPCheckList1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    With cmd
                        ...
                        .Parameters.Add("@LANDSCPE", SqlDbType.NVarChar).Value = Me.LandscapingValueTextBox.Text
                        .Parameters.Add("@LANDSCPECMP", SqlDbType.NVarChar).Value = Me.cboLandscapingValue.SelectedValue.ToString
                        .ExecuteNonQuery()
                    End With
