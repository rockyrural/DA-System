...
#Region "Navigation Code"
    ...
    Private Sub LockForm(ByVal pnl As Control, ByVal locked As Boolean)
        For Each ctrl As Control In pnl.Controls
            ...
            ElseIf TypeOf ctrl Is NumericUpDown Then
                Dim mskb As NumericUpDown = DirectCast(ctrl, NumericUpDown)
                mskb.Enabled = Not locked
    ...
    Private Sub BtnWanted_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPCA.Click, btnReferrals.Click, btnFileNotes.Click, btnFees.Click, btnDocuments.Click, btnBuildLetter.Click, btnSec68.Click, btnAdditionalInfo.Click, btnVariations.Click, btnSubmissions.Click, btnStatus.Click, btnAssociatedApps.Click, btnApplication.Click, btnEnlightenMap.Click
    ...
    Private Sub ClickButton(ByVal sender As System.Object)
        ...
        UnDockNavPanelControl(pnlDisplayApplication)
        UnDockNavPanelControl(pnlDisplayFees)
        UnDockNavPanelControl(pnlDisplayReferrals)
        UnDockNavPanelControl(pnlDisplayAssociatedApps)
        UnDockNavPanelControl(pnlDisplaySect68IntDev)
        UnDockNavPanelControl(pnlDisplayFileNotes)
        UnDockNavPanelControl(pnlDisplayDocs)
        UnDockNavPanelControl(pnlDisplayBuildLetters)
        UnDockNavPanelControl(pnlDisplayStatus)
        UnDockNavPanelControl(pnlDisplaySubmisions)
        UnDockNavPanelControl(pnlDisplayVariations)
        UnDockNavPanelControl(pnlDisplayPCAconditions)
        UnDockNavPanelControl(pnlDisplayEnlighten)
        ...
        Select Case btn.Tag.ToString.ToUpper
            Case "APPLICATION"
                ...
                Me.pnlDisplayApplication.Dock = DockStyle.Fill
                pnlSearch.Dock = DockStyle.Top

            Case "FEES"
                lblMenu.Text = "Fees"
                pnlDisplayFees.Dock = DockStyle.Fill

            Case "REFERRALS"
                lblMenu.Text = "Referrals"
                pnlDisplayReferrals.Dock = DockStyle.Fill

            Case "ASSOCIATED"
                lblMenu.Text = "Associated Applications"
                pnlDisplayAssociatedApps.Dock = DockStyle.Fill

            Case "SEC68INTDEV"
                lblMenu.Text = "Section 68 / Int Development"
                pnlDisplaySect68IntDev.Dock = DockStyle.Fill
                'LoadTrapStatus()

            Case "ADDINFO"
                'lblMenu.Text = "Additional Information"
                'pnlDisplayAditionalInfo.Dock = DockStyle.Fill
                lblMenu.Text = "Development Application Details"
                Me.pnlDisplayApplication.Dock = DockStyle.Fill
            ...
            Case "FILESNOTES"
                lblMenu.Text = "File Notes"
                pnlDisplayFileNotes.Dock = DockStyle.Fill

            Case "DOCS"
                lblMenu.Text = "Documents"
                pnlDisplayDocs.Dock = DockStyle.Fill

            Case "LETTERS"
                lblMenu.Text = "Build Letters"
                pnlDisplayBuildLetters.Dock = DockStyle.Fill

            Case "STATUS"
                lblMenu.Text = "Status"
                pnlDisplayStatus.Dock = DockStyle.Fill

            Case "SUBMISIONS"
                lblMenu.Text = "Submissions"
                pnlDisplaySubmisions.Dock = DockStyle.Fill
            ...
            Case "PCA"
                lblMenu.Text = "PCA Conditions"
                pnlDisplayPCAconditions.Dock = DockStyle.Fill

            Case "ENLIGHTEN"
                lblMenu.Text = "Enlighten Map"
                pnlDisplayEnlighten.Dock = DockStyle.Fill
    ...
    Private Sub btnImpoundDetails_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPCA.MouseEnter, btnReferrals.MouseEnter, btnFileNotes.MouseEnter, btnFees.MouseEnter, btnDocuments.MouseEnter, btnBuildLetter.MouseEnter, btnSec68.MouseEnter, btnAdditionalInfo.MouseEnter
    ...
    Private Sub btnImpoundDetails_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCA.MouseLeave, btnReferrals.MouseLeave, btnFileNotes.MouseLeave, btnFees.MouseLeave, btnDocuments.MouseLeave, btnBuildLetter.MouseLeave, btnSec68.MouseLeave, btnAdditionalInfo.MouseLeave
        Dim btn As Button = CType(sender, Button)
    ...
    Private Sub btnImpoundDetails_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles btnPCA.MouseUp, btnReferrals.MouseUp, btnFileNotes.MouseUp, btnFees.MouseUp, btnDocuments.MouseUp, btnBuildLetter.MouseUp, btnSec68.MouseUp, btnAdditionalInfo.MouseUp
    ...
    'Private Sub CheckCommandLine(ByRef e() As String)
...
#Region "Functions and Sub routines"
    ...
    Private Function SubmissionNotComplete() As Boolean
        ...
        If Not IsDate(SubRecdDate.Text) Then
            With ErrorProvider
                .SetIconAlignment(Me.btnSubRecdDate, ErrorIconAlignment.MiddleRight)
                .SetError(Me.btnSubRecdDate, "This is required")
            End With
            result = True
        Else
            ErrorProvider.SetError(Me.btnSubRecdDate, "")
        ...
        For Each ctrl As Control In pnl.Controls
            If TypeOf ctrl Is Button Then
                ...
                Select Case cb.Name
                    ...
                    Case "btnAddVariation", "btnAddSub", "btnAckSub", "btnEdit68", "btnmskDateAct", "btnAddFee", "btnAddRefund", "btnAddReferral", "btnEditReferralsTab"
...
#Region "Referrals"
    ...
    Private Sub dgvLoadListReferrals_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvLoadListReferrals.CellClick
        ...
        If Not e.RowIndex = -1 Then
            ...
            LockTheForm(pnlButtons, True)
            btnRefRetDt.Enabled = False
            btnRefdt.Enabled = False
    ...
    Private Sub LoadReferralDetails(ByVal ID As Integer)
        ...
        Refdt.Text = String.Empty
        RefRetDt.Text = String.Empty
        ...
        EngDueReturnDate.Text = String.Empty
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    If objDT.Rows.Count > 0 Then
                        ...
                        If Not IsDBNull(objDataRow.Item("Refdt")) Then Refdt.Text = Format(CDate(objDataRow.Item("Refdt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("RefRetDt")) Then RefRetDt.Text = Format(CDate(objDataRow.Item("RefRetDt")), "dd/MM/yyyy")
                        ...
                        If Not IsDBNull(objDataRow.Item("EngDueReturnDate")) Then EngDueReturnDate.Text = objDataRow.Item("EngDueReturnDate").ToString
...
#Region "Historical Docs"
    ...
    Private Sub btnDocNote_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveTheNote.Click
...
#Region "PCA Cond Tab"
    ...
    Private Sub dgvOneOffConditions_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvOneOffConditions.CellClick, dgvOneUpConditions.CellClick
        If e.ColumnIndex = -1 Then Exit Sub
...
#Region "Section68andIntDev"
    ...
    Private Sub btnSaveIntDev_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveIntDev.Click
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    With cmd
                        ...
                        If Not String.IsNullOrEmpty(mskDateAct.Text) Then .Parameters.Add("@ACTDATE", SqlDbType.SmallDateTime).Value = Format(CDate(mskDateAct.Text), "dd/MM/yyyy")
                        .ExecuteNonQuery()
...
#Region "Date Buttons"
    ...
    Private Sub btnmskDateAct_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnmskDateAct.Click
        RetrieveDate(mskDateAct)
    End Sub
...
#Region "Main Application"
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    If objDT.Rows.Count > 0 Then
                        ...
                        If Not IsDBNull(objDataRow.Item("DAToPlannerDt")) Then DAToPlannerDt.Text = Format(CDate(objDataRow.Item("DAToPlannerDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DASiteInspectedDt")) Then DASiteInspectedDt.Text = Format(CDate(objDataRow.Item("DASiteInspectedDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("PreAssessCompleteDate")) Then PreAssessCompleteDate.Text = Format(CDate(objDataRow.Item("PreAssessCompleteDate")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("RefToPlanCom")) Then RefToPlanCom.Text = Format(CDate(objDataRow.Item("RefToPlanCom")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DAToTypingDt")) Then DAToTypingDt.Text = Format(CDate(objDataRow.Item("DAToTypingDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DADetermDt")) Then DADetermDt.Text = Format(CDate(objDataRow.Item("DADetermDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DAAppNotDt")) Then DAAppNotDt.Text = Format(CDate(objDataRow.Item("DAAppNotDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("ConsentPostedDate")) Then ConsentPostedDate.Text = Format(CDate(objDataRow.Item("ConsentPostedDate")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DAFreeTreeDt")) Then DAFreeTreeDt.Text = Format(CDate(objDataRow.Item("DAFreeTreeDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DAConsentPubDt")) Then DAConsentPubDt.Text = Format(CDate(objDataRow.Item("DAConsentPubDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DAOccDt")) Then DAOccDt.Text = Format(CDate(objDataRow.Item("DAOccDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DAPermExDt")) Then DAPermExDt.Text = Format(CDate(objDataRow.Item("DAPermExDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DAAdvisedDt")) Then DAAdvisedDt.Text = Format(CDate(objDataRow.Item("DAAdvisedDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DACommDt")) Then DACommDt.Text = Format(CDate(objDataRow.Item("DACommDt")), "dd/MM/yyyy")
                        If Not IsDBNull(objDataRow.Item("DACompletedDt")) Then
                            DACompletedDt.Text = Format(CDate(objDataRow.Item("DACompletedDt")), "dd/MM/yyyy")
                        ...
                        LockTheForm(pnlDisplayApplication, False)
    ...
    Private Sub btnAddDA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddDA.Click
        ...
        ClearControls(pnlDisplayVariations)
        ClearControls(pnlDisplayPCAconditions)
        ClearControls(pnlDisplayApplication)
    ...
    Private Sub btnEditDA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEditDA.Click
        LockTheForm(pnlDisplayApplication, True)
    ...
    Private Sub btnFind_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles btnFind.KeyPress
        KeyPressSendTab(e)
    End Sub
    ...
    Private Sub txtDANo_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDANo.TextChanged
        lblapplicationNo.Text = txtDANo.Text
    End Sub
