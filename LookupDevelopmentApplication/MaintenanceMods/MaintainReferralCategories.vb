Public Class MaintainReferralCategories
    ...
    Private Sub Usp_ReferralCode_SELECTBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.Validate()
        Me.Usp_ReferralCode_SELECTBindingSource.EndEdit()
        Me.Usp_ReferralCode_SELECTTableAdapter.Update(Me.ReferralCategories.usp_ReferralCode_SELECT)
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        With dgvReferralCategories
            .AllowUserToAddRows = True
            .AllowUserToDeleteRows = True
            .ReadOnly = False
            Dim iRow As Integer = .Rows.Count
            .CurrentCell = dgvReferralCategories(0, iRow - 1)
    ...
    Private Sub btnEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        dgvReferralCategories.ReadOnly = False
        btnAdd.Enabled = False
        btnEdit.Enabled = False
        btnSave.Enabled = True
