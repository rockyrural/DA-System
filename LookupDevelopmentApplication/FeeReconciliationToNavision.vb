...
Public Class FeeReconciliationToNavision
    ...
    Private Sub FeeReconciliationToNavision_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.cboLoadUpPayment.SelectedIndex = -1
    ...
    Private Sub btnSpreadSheet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSpreadSheet.Click
        ...
        Try
            ...
            xlsheet.Cells(2, 2) = Format(CDate(dtpFromDate.Value), "dd/MM/yyyy")
            xlsheet.Cells(2, 4) = Format(CDate(dtpToDate.Value), "dd/MM/yyyy")
            ...
            xlsheet.Cells(1, 16) = Format(CDate(dtpFromDate.Value), "dd/MM/yyyy")
            xlsheet.Cells(1, 22) = Format(CDate(dtpToDate.Value), "dd/MM/yyyy")
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    With cmd
                        ...
                        .Parameters.Add("@PARAMNO", SqlDbType.Int).Value = CInt(cboLoadUpPayment.SelectedValue)
                        .Parameters.Add("@STARTDATE", SqlDbType.SmallDateTime).Value = Format(CDate(dtpFromDate.Value), "dd/MM/yyyy")
                        .Parameters.Add("@ENDDATE", SqlDbType.SmallDateTime).Value = Me.dtpToDate.Value
    ...
    Private Function ImportCSVData() As Boolean
        ...
        Try
            ...
            Do While Not line Is Nothing
                ...
                words = line.Split(test, StringSplitOptions.None)


                InsertRowIntoRegister(CDate(words(0).Substring(1, 8)), words(3).ToString, words(5).ToString, CDbl(words(11)))
