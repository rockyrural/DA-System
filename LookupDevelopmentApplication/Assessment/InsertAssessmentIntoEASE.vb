...
Public Class InsertAssessmentIntoEASE
...
#End Region
    ...
    Private Sub MoveTheDocument()
        Try
            If My.Computer.FileSystem.FileExists(DocumentLocation) Then
                Dim Filename As String = EASEfunctions.CreateNewFileName(DocNo)

                My.Computer.FileSystem.MoveFile(DocumentLocation, My.Settings.EASEOUTPUTFOLDER & Filename)
