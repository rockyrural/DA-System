...
Public Class TestAssessmentForm
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    With cmd
                        ...
                        If cboVariationType.Text <> String.Empty Then .Parameters.Add("@TYPE", SqlDbType.SmallInt).Value = CInt(cboVariationType.EditValue)
...
#Region "Conclusions"
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    With cmd
                        ...
                        If cboReferralsYesNo.Text <> String.Empty Then .Parameters.Add("@ReferralsYesNo", SqlDbType.NVarChar).Value = Me.cboReferralsYesNo.EditValue.ToString
                        If cboComplianceStatProvYesNo.Text <> String.Empty Then .Parameters.Add("@ComplianceStatProvYesNo", SqlDbType.NVarChar).Value = Me.cboComplianceStatProvYesNo.EditValue.ToString
                        .Parameters.Add("@ComplianceStatProvComments", SqlDbType.NText).Value = Me.ComplianceStatProvCommentsTextBox.Text
                        If cboVariationsYesNo.Text <> String.Empty Then .Parameters.Add("@VariationsYesNo", SqlDbType.NVarChar).Value = Me.cboVariationsYesNo.EditValue.ToString
                        .Parameters.Add("@VariationsComment", SqlDbType.NText).Value = txtVariationComment.Text

                        If cboApplicationConclResult.Text <> String.Empty Then .Parameters.Add("@ApplicationConclResult", SqlDbType.NVarChar).Value = Me.cboApplicationConclResult.EditValue.ToString
                        ...
                        If modification Then
                            ...
                            If cboModAssessmentDecision.Text <> String.Empty Then .Parameters("@AssessmentDecision").Value = Me.cboModAssessmentDecision.EditValue.ToString
                            If cboModAuthority.Text <> String.Empty Then .Parameters("@AuthorityCode").Value = Me.cboModAuthority.EditValue.ToString
                        ...
                        Else
                            ...
                            If cboAssessmentDecision.Text <> String.Empty Then .Parameters("@AssessmentDecision").Value = Me.cboAssessmentDecision.EditValue.ToString
                            If cboAuthority.Text <> String.Empty Then .Parameters("@AuthorityCode").Value = Me.cboAuthority.EditValue.ToString
                            .Parameters("@PropDetermDate").Value = Format(CDate(txtConclusionDate.Text), "dd/MM/yyyy")
                        End If


                        If cboModSec96Comply.Text <> String.Empty Then .Parameters.Add("@Modsec96ComplyYN", SqlDbType.NVarChar).Value = Me.cboModSec96Comply.EditValue.ToString
                        If cboModSec79Satisfactory.Text <> String.Empty Then .Parameters.Add("@Modsec79SatisYN", SqlDbType.NVarChar).Value = Me.cboModSec79Satisfactory.EditValue.ToString
                        .ExecuteNonQuery()
    ...
    Private Function ConclusionChecksOut() As Boolean
        ...
        If Not cboReferralsYesNo.EditValue Is Nothing Then
            With ErrorProvider
        ...
        If Not cboComplianceStatProvYesNo.EditValue Is Nothing Then
            With ErrorProvider
        ...
        If Not cboVariationsYesNo.EditValue Is Nothing Then
            With ErrorProvider
        ...
        If Not cboApplicationConclResult.EditValue Is Nothing Then
            With ErrorProvider
        ...
        If Not cboAuthority.EditValue Is Nothing Then
            With ErrorProvider
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    With cmd
                        ...
                        If ModMinEnvImpactYNComboBox.Text <> String.Empty Then .Parameters.Add("@ModMinEnvImpactYN", SqlDbType.NVarChar).Value = Me.ModMinEnvImpactYNComboBox.EditValue.ToString
                        .Parameters.Add("@ModMinEnvImpComment", SqlDbType.NText).Value = Me.ModMinEnvImpCommentTextBox.Text
                        If ModSubstSameYNComboBox.Text <> String.Empty Then .Parameters.Add("@ModSubstSameYN", SqlDbType.NVarChar).Value = Me.ModSubstSameYNComboBox.EditValue.ToString
                        .Parameters.Add("@SubStSameComment", SqlDbType.NText).Value = Me.ModSubStSameCommentTextBox.Text
                        If ModNotificationYNComboBox.Text <> String.Empty Then .Parameters.Add("@ModNotificationYN", SqlDbType.NVarChar).Value = Me.ModNotificationYNComboBox.EditValue.ToString
                        If ModSubmConsYNComboBox.Text <> String.Empty Then .Parameters.Add("@ModSubmConsYN", SqlDbType.NVarChar).Value = Me.ModSubmConsYNComboBox.EditValue.ToString
                        If ModConsMinisterYNComboBox.Text <> String.Empty Then .Parameters.Add("@ModConsMinisterYN", SqlDbType.NVarChar).Value = Me.ModConsMinisterYNComboBox.EditValue.ToString
                        If ModMinisterOBjYNComboBox.Text <> String.Empty Then .Parameters.Add("@ModMinisterOBjYN", SqlDbType.NVarChar).Value = Me.ModMinisterOBjYNComboBox.EditValue.ToString
                        .Parameters.Add("@ModMinisterComment", SqlDbType.NText).Value = Me.ModMinisterCommentTextBox.Text
                        If ModThreatSpecYNComboBox.Text <> String.Empty Then .Parameters.Add("@ModThreatSpecYN", SqlDbType.NVarChar).Value = Me.ModThreatSpecYNComboBox.EditValue.ToString
                        If ModThreatComplYNComboBox.Text <> String.Empty Then .Parameters.Add("@ModThreatComplYN", SqlDbType.NVarChar).Value = Me.ModThreatComplYNComboBox.EditValue.ToString
                        .Parameters.Add("@ModThreatComment", SqlDbType.NText).Value = Me.ModThreatCommentTextBox.Text
                        If Modsect79cYNComboBox.Text <> String.Empty Then .Parameters.Add("@Modsect79cYN", SqlDbType.NVarChar).Value = Me.Modsect79cYNComboBox.EditValue.ToString
                        .Parameters.Add("@ModSect79cComment", SqlDbType.NText).Value = Me.ModSect79cCommentTextBox.Text
                        If ModSect94YNComboBox.Text <> String.Empty Then .Parameters.Add("@ModSect94YN", SqlDbType.NVarChar).Value = Me.ModSect94YNComboBox.EditValue.ToString
...
#Region "Contributions"
    ...
    Private Function CheckSection64() As Boolean
        ...
        If Not cboSection64Type.EditValue Is Nothing Then
            With ErrorProvider
        ...
        If Not cboS64Type.EditValue Is Nothing Then
            With ErrorProvider
        ...
        'End If
        If Not cboContribType.EditValue Is Nothing Then
            With ErrorProvider
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    If objDT.Rows.Count > 0 Then
                        ...
                        If Not IsDBNull(objDataRow.Item("ActedOn")) Then cboActedOn.EditValue = CInt(objDataRow.Item("ActedOn"))
...
#End Region
    ...
    Private Sub gvwVariations_RowClick(sender As Object, e As DevExpress.XtraGrid.Views.Grid.RowClickEventArgs) Handles gvwVariations.RowClick
        ...
        Me.cboVariationType.Text = myobj.Row.Item("Variation").ToString
        txtVariationDetails.Text = myobj.Row.Item("detail").ToString
        Me.cboVariationResult.EditValue = myobj.Row.Item("result").ToString
        ...
        If valuetocheck <> String.Empty Then
            Me.variationDecisionDate.Text = Format(CDate(myobj.Row.Item("DecisionDate").ToString), "dd/MM/yyyy")
        End If
        cboOfficerRecomforVariation.Text = myobj.Row.Item("AssResult").ToString
        txtOfficersReasons.Text = myobj.Row.Item("AssReasons").ToString
