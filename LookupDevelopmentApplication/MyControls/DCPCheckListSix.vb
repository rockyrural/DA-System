            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    With cmd
                        ...
                        .Parameters.Add("@COMBEE", SqlDbType.NVarChar).Value = DWCombEETextBox.Text
                        If Not IsNothing(cboDWCombEE) Then .Parameters.Add("@COMBEECMP", SqlDbType.NVarChar).Value = cboDWCombEE.SelectedValue.ToString
                        ...
                        .Parameters.Add("@COMPSENT", SqlDbType.NVarChar).Value = DWCombSEntTextBox.Text
                        If Not IsNothing(cboDWCoombSent) Then .Parameters.Add("@COMPSENTCMP", SqlDbType.NVarChar).Value = cboDWCoombSent.SelectedValue.ToString
                        .Parameters.Add("@COMPSEXT", SqlDbType.NVarChar).Value = DWCombSExtTextBox.Text
                        If Not IsNothing(cboDWCoombSext) Then .Parameters.Add("@COMPSEXTCMP", SqlDbType.NVarChar).Value = cboDWCoombSext.SelectedValue.ToString
                        .Parameters.Add("@DWSPACE", SqlDbType.NVarChar).Value = DWSpaceTextBox.Text
                        If Not IsNothing(cboDWSpace) Then .Parameters.Add("@DWSPACECMP", SqlDbType.NVarChar).Value = cboDWSpace.SelectedValue.ToString
                        .Parameters.Add("@EPS", SqlDbType.NVarChar).Value = EPSValueTextBox.Text
                        If Not IsNothing(cboEPS) Then .Parameters.Add("@EPSCMP", SqlDbType.NVarChar).Value = cboEPS.SelectedValue.ToString
                        .Parameters.Add("@VISITOR", SqlDbType.NVarChar).Value = OSVisitorValueTextBox.Text
                        If Not IsNothing(cboOSvisitorParking) Then .Parameters.Add("@VISITORCMP", SqlDbType.NVarChar).Value = cboOSvisitorParking.SelectedValue.ToString
