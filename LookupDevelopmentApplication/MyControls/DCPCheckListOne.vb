...
Public Class DCPCheckListOne
    ...
    Private Sub SetUpDCPCheck1ComboBoxs()
        ...
        Dim Landscaping As New ArrayList
        ...
        With Me.cboLandscapingValue
            .DataSource = Landscaping
            .DisplayMember = "Name"
            .ValueMember = "Key"
            .SelectedIndex = -1
        End With
            ...
            Try
                ...
                Using cmd As New SqlCommand
                    ...
                    With cmd
                        ...
                        .Parameters.Add("@FORM", SqlDbType.Int).Value = 1
                        If Not IsNothing(cboNatHERSComply.SelectedValue) Then .Parameters.Add("@NATHERS", SqlDbType.NVarChar).Value = cboNatHERSComply.SelectedValue.ToString
                        .Parameters.Add("@NATHERRATING", SqlDbType.NVarChar).Value = NatHERS_RatingTextBox.Text
                        If Not IsNothing(cboFSR.SelectedValue) Then .Parameters.Add("@FSR", SqlDbType.NVarChar).Value = cboFSR.SelectedValue.ToString
                        .Parameters.Add("@FLOOR", SqlDbType.NVarChar).Value = DAFloorTextBox.Text
                        If Not IsNothing(cboMaxHeight.SelectedValue) Then .Parameters.Add("@HEIGHTCOMPLY", SqlDbType.NVarChar).Value = cboMaxHeight.SelectedValue.ToString
                        ...
                        If Not IsNothing(cboSetBkFront.SelectedValue) Then .Parameters.Add("@SETBKFCMP", SqlDbType.NVarChar).Value = cboSetBkFront.SelectedValue.ToString
                        .Parameters.Add("@SETBKS", SqlDbType.NVarChar).Value = SetbackSTextBox.Text
                        If Not IsNothing(cboSetBkS.SelectedValue) Then .Parameters.Add("@SETBKSCMP", SqlDbType.NVarChar).Value = cboSetBkS.SelectedValue.ToString
                        .Parameters.Add("@SETBKSS", SqlDbType.NVarChar).Value = SetbackSSTextBox.Text
                        If Not IsNothing(cbosetbkSS.SelectedValue) Then .Parameters.Add("@SETBKSSCMP", SqlDbType.NVarChar).Value = cbosetbkSS.SelectedValue.ToString
                        .Parameters.Add("@SETBKR", SqlDbType.NVarChar).Value = SetbackRTextBox.Text
                        If Not IsNothing(cboSetBkR.SelectedValue) Then .Parameters.Add("@SETBKRCMP", SqlDbType.NVarChar).Value = cboSetBkR.SelectedValue.ToString
                        .Parameters.Add("@SETBKFS", SqlDbType.NVarChar).Value = SetbackFSTextBox.Text
                        If Not IsNothing(cboSetBkFS.SelectedValue) Then .Parameters.Add("@SETBKFSCMP", SqlDbType.NVarChar).Value = cboSetBkFS.SelectedValue.ToString
                        .Parameters.Add("@OSPARKSPACE", SqlDbType.NVarChar).Value = OSParkSpaceTextBox.Text
                        If Not IsNothing(cboOSParkSpace.SelectedValue) Then .Parameters.Add("@OSPARKSPACECMP", SqlDbType.NVarChar).Value = cboOSParkSpace.SelectedValue.ToString
                        .Parameters.Add("@OSPARKPROX", SqlDbType.NVarChar).Value = OSParkProxTextBox.Text
                        If Not IsNothing(cboOSParkPRox.SelectedValue) Then .Parameters.Add("@OSPARKPROXCMP", SqlDbType.NVarChar).Value = cboOSParkPRox.SelectedValue.ToString
                        .Parameters.Add("@OSPARKENTRY", SqlDbType.NVarChar).Value = OSParkEntryTextBox.Text
                        If Not IsNothing(cboOSParkEntry.SelectedValue) Then .Parameters.Add("@OSPARKENTRYCMP", SqlDbType.NVarChar).Value = cboOSParkEntry.SelectedValue.ToString
                        .Parameters.Add("@OPENSPACE", SqlDbType.NVarChar).Value = OpenSpaceTextBox.Text
                        If Not IsNothing(cboOSParkPRox.SelectedValue) Then .Parameters.Add("@OPENSPACECMP", SqlDbType.NVarChar).Value = cboOSParkPRox.SelectedValue.ToString
                        .Parameters.Add("@LANDSCPE", SqlDbType.NVarChar).Value = LandscapingValueTextBox.Text
                        If Not IsNothing(cboLandscapingValue.SelectedValue) Then .Parameters.Add("@LANDSCPECMP", SqlDbType.NVarChar).Value = cboLandscapingValue.SelectedValue.ToString
                        .ExecuteNonQuery()
                    End With
    ...
    Private Function CheckDataEntry() As Boolean
        ...
        If Me.cboLandscapingValue.Text = String.Empty Then
            With ErrorProvider
                .SetIconAlignment(Me.cboLandscapingValue, ErrorIconAlignment.MiddleRight)
                .SetError(Me.cboLandscapingValue, "Answer is required")
            End With
            result = False
        Else
            ErrorProvider.SetError(Me.cboLandscapingValue, "")

            If cboLandscapingValue.SelectedValue.ToString <> "O" Then
                If Me.LandscapingValueTextBox.Text = String.Empty Then
                    With ErrorProvider
                        .SetIconAlignment(Me.LandscapingValueTextBox, ErrorIconAlignment.MiddleRight)
                        .SetError(Me.LandscapingValueTextBox, "Answer is required")
                    End With
                    result = False
                Else
                    ErrorProvider.SetError(Me.LandscapingValueTextBox, "")
